...
\caption{High learning-rate training rewards through time.}
\end{figure}


\begin{figure}
\centerline{\includegraphics[scale=0.6]{DQN_family_breakout_results/high_lr_testing.png}
\caption{The testing rate for our models during a high learning-rate experiment, seen as the rewards from 100 testing trials during stages of training.}
\end{figure}
