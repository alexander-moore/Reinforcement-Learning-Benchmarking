...
$Y{_{t}}^{DoubleDQN}\equiv R_{t+1}+\gamma Q(S_{t+1},\underset{a}{argmax}Q(S_{t+1},a;\Theta _{t}),\Theta {_{t}}^{-})$
...
As opposed to single step Deep Q Learning, multi-step acrues rewards over n-step periods with rewards accumulated over that period with gamma discounting before being applied in a similar DQN structure.
...
\subsection{Discrete DQN Variations}
